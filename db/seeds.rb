...
seed_list = [
    ["Post test 1", "Author test 1", "Content test 1"],
    ...
    ["Post test 12", "Author test 12", "Content test 12"],
    ...
    ["Post test 22", "Author test 22", "Content test 22"],
...
seed_list.each do |title, author, content|
